...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative z-10 items-start justify-between md:px-36 px-8 md:pt-16 pt-10 text-left">
                      ...
                      <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                        ...
                        <div className="flex gap-2 ">
                          {lecture.isPreviewFree && (
                            ...
                            className="text-green-600 cursor-pointer">Preview</p>
                          )}
                          <p>
                            {humanizeDuration(
