    ...
    <div className="min-h-screen flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          ...
          {/* Total Enrollments */}
          <div className="flex items-center gap-4 bg-white shadow-md border border-blue-500 p-5 w-60 rounded-xl hover:shadow-lg hover:scale-105 transition-transform duration-200">
